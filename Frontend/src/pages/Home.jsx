...
function Home() {
  ...
  return (
    <>
      ...
      <p>מתכננים אירוע שמחה ומחפשים רעיונות יצירתיים?  EvenTracking מאגד את מיטב הספקים לחתונות, בר מצוות, ימי הולדת ועוד - במקום אחד וללא עלות! 
      <section className='heading'>

        עיינו במגוון רחב של הצעות לאולמות, קייטרינג, עיצוב, מוזיקה, צילום ועוד. 
        קבלו השראה ליצירת אירוע מושלם בדיוק בסגנונכם. נהנו מהמלצות אישיות, ביקורות משתמשים אמינות ואפשרות להשוואה בין ספקים שונים - 
        הכל כדי לעזור לכם לבחור נכון ולחסוך בזמן וכסף. 
        הצטרפו ל EvenTracking 
        </section>

        -  וקבלו גישה למדריך האירועים המקיף ביותר, ללא עלות! 
        יחד ניצור את האירוע המושלם עבורך </p>
      </section>

      <section className='heading'>
        <p>האתר מציע מגוון רחב של ספקים מהטובים בתחום - מה שעושה אותו לפלטפורמה המובילה לתכנון אירועים.
           החל מאולמות, דיג'ייז, צלמים, מעצבים וכלה בספקים ייחודיים כמו סדנאות יצירה לילדים.
           <section className='heading'>
